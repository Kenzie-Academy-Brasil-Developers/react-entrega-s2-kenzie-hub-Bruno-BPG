      ...
      <form className="cadastro-form">
        ...
        <div className="alinharCentro">
          <select name="cargo" class="alinarImput">
            <option className="ajustarCorGrey" value="Primeiro">
              Primeiro Modulo
            </option>
            <option className="ajustarCorGrey" value="Segundo">
              Segundo Modulo
            </option>
            <option className="ajustarCorGrey" value="Terceiro">
              Terceiro Modulo
            </option>
            <option className="ajustarCorGrey" value="Quarto">
              Quarto Modulo
            </option>
            <option className="ajustarCorGrey" value="Quinto">
              Quinto Modulo
            </option>
          </select>
        </div>
